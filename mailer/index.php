...
try {
    ...
    $mail->Username = 'hr@alruwialtasneem.com';                 // SMTP username
    $mail->Password = 'AlTasneem@123';                           // SMTP password
...
'allow_self_signed' => true
   ...
   $mail1->isSMTP();                                      // Set mailer to use SMTP
    $mail1->Host = 'smtpout.asia.secureserver.net';  // Specify main and backup SMTP servers
    $mail1->SMTPAuth = true;                               // Enable SMTP authentication
    $mail1->Username = 'hr@alruwialtasneem.com';                 // SMTP username
    $mail1->Password = 'AlTasneem@123';                           // SMTP password

    $mail1->SMTPSecure = 'TLS';                            // Enable TLS encryption, `ssl` also accepted
    $mail1->Port = '80';                                    // TCP port to connect to
...
'allow_self_signed' => true
    ...
    $mail->setFrom('hr@alruwialtasneem.com', 'Al ruwi Al Tasneem LLc');
    ...
    $mail->Subject = 'Al ruwi Al Tasneem LLc';
    $mail->Body    = $body;
    $mail->AltBody =  strip_tags($body);
    $mail->send();

    $mail1->setFrom($email, 'Al ruwi Al Tasneem LLc');
    $mail1->addAddress('hr@alruwialtasneem.com');     // Add a recipient
    ...
    $body = '<p>A Customer wants to contact us</p><p>Name : .'.$name.'</p><p>Email : '.$email.'</p><p><p>Phone Number: '.$phone_no.'</p><p>Message : '.$message.' </p>';
    ...
    $mail1->Subject = 'Al ruwi Al Tasneem LLc Contact US';
    $mail1->Body    = $body;
